...
create index idx_analytics_events_created_at on public.analytics_events(created_at desc);-- Row Level Security (RLS) policies
...
-- alter table public.leads enable row level security;-- Insert default subjects
